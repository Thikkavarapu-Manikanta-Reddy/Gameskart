...
.far1 {
    /* The image used */
    background-image: url('far-cry-4.jpg');
...
.far2 {
    /* The image used */
    background-image: url('2293560a9359a3da88e92fce41b7fefc26d230e1-989620.jpg');
...
<div class="gallery">
  <a target="_blank" href="Far-Cry-4-PS3-300x343.jpg">
    <img src="Far-Cry-4-PS3-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>FAR CRY 4-EXTENDED PS3 </h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.899</h3>
    <hr>
    <button onClick="location.href='cart11'" class="add">ADD TO CART</button>
    <hr>
...
<div class="container-fluid">
 ...
 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
  ...
  <div id="demo1" class="collapse">
    <h1>Description</h1>
<h3>Built from the legendary DNA of its award-winning predecessor, Far CryÂ® 4 delivers the most expansive and immersive Far CryÂ® experience ever in an entirely new and massive open world, with integrated drop-in/drop-out open world co-op play.

Hidden in the towering Himalayas lies Kyrat, a country steeped in tradition and violence. You are Ajay Ghale. Traveling to Kyrat to fulfill your motherâs dying wish, you find yourself caught up in a civil war to overthrow the oppressive regime of dictator Pagan Min. Explore and navigate this vast open world, where danger and unpredictability lurk around every corner. Here, every decision counts, and every second is a story. Welcome to Kyrat.</h3>
