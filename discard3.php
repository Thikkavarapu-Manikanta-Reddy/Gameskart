...
$sql = "DELETE FROM cart WHERE ID='$id' AND USERNO = '$ht'";
...
$sql = "SELECT ID,PRODUCT,PRICE,QUANTITY,TOTAL FROM cart WHERE USERNO = '$ht'";
...
echo "</table>";
    ...
    echo "<h1><strong><center>YOUR CART IS EMPTY!</center></strong></h1>";
}
$conn->close();
?>
<hr>
...
<button type="button" class="extra" class="btn btn-info" data-toggle="collapse" data-target="#demo2">Discard Item</button>
  ...
  <div class="form-group">
    <label for="pd">Enter ProductID</label>
    <input type="text" class="form-control"  name="pd" placeholder="ID.....">
  </div>
