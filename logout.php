...
.watchdogs2 {
    /* The image used */
    background-image: url('3079957-watchdogs2-e32016_20160610-promo_v1.jpg');
...
.godofwar {
    /* The image used */
    background-image: url('god_of_war_kratos_ps4-wide.jpg');
...
$sql = "DELETE FROM cart WHERE USERNO='$tin'";
...
<div class="heck">
  <form action="decidelogin" method="post">
