...
.untill1 {
    /* The image used */
    background-image: url('until_dawn_wallpaper_by_mrjuniorer-d9qtwwv.jpg');
...
.untill2 {
    /* The image used */
    background-image: url('9_1436948695-ds1-670x377-constrain.jpg');
...
<div class="gallery">
  <a target="_blank" href="Until-Dawn-Ps4-300x343.jpg">
    <img src="Until-Dawn-Ps4-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>UNTIL DAWN EXTENDED PS4</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.1199</h3>
    <hr>
    <button onClick="location.href='cart5'" class="add">ADD TO CART</button>
    <hr>
...
<div class="container-fluid">
 ...
 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
  ...
  <div id="demo1" class="collapse">
    <h1>Description</h1>
<h3>When eight friends become trapped on a remote mountain getaway gone wrong, things quickly turn sinister and they start to suspect they arenÃ¢ÂÂt alone. Gripped by fear and with tensions in the group running high, youÃ¢ÂÂll be forced to make snap decisions that could mean life or death for everyone involved. Every choice you make while playing as each of the eight friends Ã¢ÂÂ even the seemingly trivial ones Ã¢ÂÂ will carve out your own unique story.

With spine-tingling performances from a Hollywood cast including Hayden Panettiere (Heroes, Nashville) brought to life with the power of PlayStation 4 Ã¢ÂÂ your actions alone will decide who survives Until Dawn.</h3>
