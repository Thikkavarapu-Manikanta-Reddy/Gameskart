...
if ($conn-> connect_error) {
   ...
   $sql = "SELECT NAME,EMAIL,MOBILEPHONE,ADDRESS FROM signup WHERE USERID = '$man'";
...
$sql = "SELECT PRODUCT,PRICE,QUANTITY,TOTAL FROM cart WHERE USERNO = '$an' ";
...
$sql = "SELECT TOTAL FROM cart WHERE USERNO = '$can'";
