...
$sql = "DELETE FROM cart WHERE ID='$id' AND USERNO ='$hit'";
...
$sql = "SELECT ID,PRODUCT,PRICE,QUANTITY,TOTAL FROM cart WHERE USERNO ='$hit'";
...
<button type="button" class="extra" class="btn btn-info" data-toggle="collapse" data-target="#demo2">Discard Item</button>
  ...
  <form  action="discard2" method="post">
  <div class="form-group">
    <label for="id">Enter ProductID</label>
    <input type="text" class="form-control"  name="id" placeholder="ID.....">
  </div>
...
$sql = "SELECT TOTAL FROM cart WHERE USERNO = '$ht'";
