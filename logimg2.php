...
.cod1 {
    /* The image used */
    background-image: url('Call-of-Duty-WWII-ESRB-Rating-competitive-sledgehammer-games-leak.jpg');
...
.cod2 {
    /* The image used */
    background-image: url('3311449-02_cod.jpg');
...
<div class="gallery">
  <a target="_blank" href="PS4-Call-Of-Duty-WWII-300x343.jpg">
    <img src="PS4-Call-Of-Duty-WWII-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>Call Of Duty WW2 PS4</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.1099</h3>
    <hr>
    <button onClick="location.href='cart2'" class="add">ADD TO CART</button>
    <hr>
