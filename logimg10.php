...
.dis1 {
    /* The image used */
    background-image: url('dishonored.jpg');
...
.dis2 {
    /* The image used */
    background-image: url('dishonored_2_screenshot_5__1.jpg');
...
<div class="gallery">
  <a target="_blank" href="Dishonored-PS3-300x343.jpg">
    <img src="Dishonored-PS3-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>DISHONORED-EXTENDED PS3</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.799</h3>
    <hr>
    <button onClick="location.href='cart10'" class="add">ADD TO CART</button>
    <hr>
