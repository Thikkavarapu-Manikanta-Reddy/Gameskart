...
.infamous1 {
    /* The image used */
    background-image: url('Second_Son_Banner.jpg');
...
.infamous2 {
    /* The image used */
    background-image: url('InFAMOUS_Second_Son-Delsin_Rocket.png');
...
<div class="gallery">
  <a target="_blank" href="inFAMOUS-Second-Son-PlayStation-4-Cover-Art-300x343.jpg">
    <img src="inFAMOUS-Second-Son-PlayStation-4-Cover-Art-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>Infamous Second Son PS4</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.999</h3>
    <hr>
    <button onClick="location.href='cart1'" class="add">ADD TO CART</button>
    <hr>
...
inFAMOUS Second Son, a PlayStation 4 exclusive, brings you an action adventure game where surrounded by a society that fears them, superhumans are ruthlessly hunted down and caged by the Department of Unified Protection (D.U.P).
...
Pre-owned games may have minor scratches but are guaranteed to work.</h3></strong>
  </div>
