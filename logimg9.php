...
.god1 {
    /* The image used */
    background-image: url('bJZlhfn.jpg');
...
.god2 {
    /* The image used */
    background-image: url('God-of-War®-III-Remastered_20150710213726.jpg');
...
<div class="gallery">
  <a target="_blank" href="God-of-War-III-PS3-300x343.jpg">
    <img src="God-of-War-III-PS3-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>GOD OF WAR 3 EXTENDED PS3</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.499</h3>
    <hr>
    <button onClick="location.href='cart9'" class="add">ADD TO CART</button>
    <hr>
...
<div class="container-fluid">
 ...
 <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
  ...
  <div id="demo1" class="collapse">
    <h1>Description</h1>
<h3>God of War III finds Kratos raining carnage and destruction upon the Gods who have betrayed him and the entire Ancient Greek world. Armed with his deadly double-chained blades, Kratos will take on mythologyÃ¢ÂÂs darkest creatures while solving intricate puzzles on his merciless quest to destroy Olympus and the mighty Zeus himself.</h3>
