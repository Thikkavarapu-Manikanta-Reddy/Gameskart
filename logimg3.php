...
.msg1 {
    /* The image used */
    background-image: url('Artworks-metal-gear-solid-v-the-phantom-pain-038.jpg');
...
.msg2 {
    /* The image used */
    background-image: url('maxresdefault (4).jpg');
...
<div class="gallery">
  <a target="_blank" href="METAL-GEAR-SOLID-V-THE-PHANTOM-PAIN-PS4-300x343.jpg">
    <img src="METAL-GEAR-SOLID-V-THE-PHANTOM-PAIN-PS4-300x343.jpg" alt="Trolltunga Norway" width="850" height="350">
  </a>
</div>
</div>
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5">
    <br>
    <h1>MSGV-THE PHANTOM PAIN PS4</h1>
    <h3 style="color:red">Free Delivery All Over USA</h3>
    <hr>
    <h3>Rs.1099</h3>
    <hr>
    <button onClick="location.href='cart3'" class="add">ADD TO CART</button>
    <hr>
